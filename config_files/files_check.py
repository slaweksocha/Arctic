...
from config_files.all_extracts import extract_data_lidl, extract_data_norma, extract_data_aldi_nord, \
    extract_data_kaufland, extract_data_hoferAT, extract_data_aldi_sued, extract_data_aldi_sued_2
                        ...
                        try:
                            ...
                            try:
                                if kontrahent_extract_data == 'extract_data_hoferAT':
                                    ...
                                    break
                                elif kontrahent_extract_data == 'extract_data_aldi_sued' and (pdf_name.find('Attachment') != -1):
